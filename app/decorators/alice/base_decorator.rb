...
class Alice::BaseDecorator < ApplicationDecorator
  ...
  def comment_decorated comment, o={}
    comment_decorator_class.new comment, context: inherit_options(o)
  end
  ...
  def show_form css_class
    h.content_tag :div, :class => css_class do
      if h.can? :create, :comments
        ...
        "Вы не можете оставить комментарий. Пожалуйста, #{link_to 'авторизируйтесь', login_url} или #{link_to 'зарегистрируйтесь', signup_url} на сайте.".html_safe
      end
    end
  end
